...
export default function CamerasPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get cameras products
        const camerasProducts = allProducts.filter(p => p.category === 'Electronics');
        setProducts(camerasProducts);
      } catch (error) {
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Cameras</h1>
            <p className="text-xl mb-6">Capture life's moments with premium photography equipment</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From DSLRs to mirrorless cameras and accessories for every photographer.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Professional grade & consumer electronics</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">DSLRs, mirrorless, action cams & more</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Camera Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">DSLR</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">DSLR Cameras</h3>
                <p className="text-[#555555] mb-4">Professional-grade digital SLR cameras</p>
                <Link href="/electronics/cameras/dslr" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Mirrorless</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Mirrorless Cameras</h3>
                <p className="text-[#555555] mb-4">Compact, powerful, and versatile</p>
                <Link href="/electronics/cameras/mirrorless" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Action</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Action Cameras</h3>
                <p className="text-[#555555] mb-4">For adventure, sports & extreme conditions</p>
                <Link href="/electronics/cameras/action" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Camera Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Cameras Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our camera collection. Check back soon!</p>
              <Link href="/electronics" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Electronics
              </Link>
            </div>
