...
export default function CamerasPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get camera products - filter by category and keyword matching
        const cameraProducts = allProducts.filter(p => 
          p.category === 'Electronics' && 
          (p.name.toLowerCase().includes('camera') || 
           p.name.toLowerCase().includes('dslr') || 
           p.name.toLowerCase().includes('mirrorless') ||
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-20">
        <div className="container-premium">
          ...
          >
            ...
            <p className="text-xl mb-6">Professional photography equipment</p>
            <div className="flex flex-wrap gap-4">
              <Link href="/electronics/cameras" className="btn-premium btn-primary !h-12 !px-8">
                Shop All Cameras
              </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-3/4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="h2">All Cameras</h2>
            ...
            {products.length > 0 ? (
              ...
              <div className="text-center py-16">
                <p className="text-lg text-[#555555]">No cameras available at the moment.</p>
              </div>
            )}
          </div>
        </div>
