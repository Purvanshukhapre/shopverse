  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        ...
        const speakersProducts = allProducts.filter(p => p.category === 'Electronics');
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          ...
          >
            ...
            <p className="text-xl mb-6">Immersive audio experiences for every space</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From portable Bluetooth speakers to premium home theater systems.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Hi-Fi audio & premium materials</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Portable, home, car & professional speakers</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Speaker Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Portable</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Portable Speakers</h3>
                <p className="text-[#555555] mb-4">Compact, battery-powered, and water-resistant</p>
                <Link href="/electronics/speakers/portable" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Home Audio</h3>
                <p className="text-[#555555] mb-4">Soundbars, bookshelf speakers & home theater</p>
                <Link href="/electronics/speakers/home" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Professional</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Pro Audio</h3>
                <p className="text-[#555555] mb-4">Studio monitors, PA systems & DJ equipment</p>
                <Link href="/electronics/speakers/pro" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Speaker Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Speakers Available</h3>
              <p className="text-[#555555] mb-6">We&apos;re working on expanding our speaker collection. Check back soon!</p>
              <Link href="/electronics" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Electronics
              </Link>
            </div>
