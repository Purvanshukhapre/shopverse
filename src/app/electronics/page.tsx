...
const HERO_SLIDES = [
  {
    id: 1,
    headline: "Tech Sale",
    sub: "Up to 50% Off — Ends Tonight",
    tag: "LIMITED OFFER",
    cta: "Shop Now",
    href: "/electronics/sale",
    bg: "from-[#0F172A] to-[#1E3A5F]",
    accent: "#F97316",
    img: "https://images.unsplash.com/photo-1593642634443-78ec7571ae3d?q=80&w=900&auto=format&fit=crop",
  },
  {
    id: 2,
    headline: "New Launches",
    sub: "Latest Gadgets from Top Brands",
    tag: "JUST DROPPED",
    cta: "Explore",
    href: "/electronics/new-arrivals",
  ...
  },
  {
    ...
    sub: "Power Up Your Setup",
    tag: "TRENDING",
    cta: "View Collection",
    href: "/electronics/gaming",
    bg: "from-[#0A1A0A] to-[#1A3A1A]",
    accent: "#22C55E",
    img: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?q=80&w=900&auto=format&fit=crop",
  },
];

const CATEGORIES = [
  { name: "Smartphones", href: "/mobiles/smartphones", img: "https://images.unsplash.com/photo-1593642634443-78ec7571ae3d?q=80&w=400&auto=format&fit=crop", count: "1.2k+" },
  { name: "Laptops", href: "/electronics/laptops", img: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=400&auto=format&fit=crop", count: "850+" },
  { name: "Headphones", href: "/electronics/headphones", img: "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?q=80&w=400&auto=format&fit=crop", count: "620+" },
  { name: "Cameras", href: "/electronics/cameras", img: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=400&auto=format&fit=crop", count: "340+" },
  { name: "Wearables", href: "/electronics/wearables", img: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?q=80&w=400&auto=format&fit=crop", count: "480+" },
  { name: "Audio", href: "/electronics/speakers", img: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=400&auto=format&fit=crop", count: "560+" },
  { name: "Accessories", href: "/electronics/accessories", img: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=400&auto=format&fit=crop", count: "2.1k+" },
  { name: "Gaming", href: "/electronics/gaming", img: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?q=80&w=400&auto=format&fit=crop", count: "930+" },
];

const BRANDS = [
  { name: "Apple", logo: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo.png", deal: "Up to 40% off" },
  { name: "Samsung", logo: "https://upload.wikimedia.org/wikipedia/commons/0/0c/Samsung_logo.svg", deal: "Min 30% off" },
  { name: "Sony", logo: "https://upload.wikimedia.org/wikipedia/commons/2/2a/Sony_logo.svg", deal: "Buy 2 Get 1" },
  { name: "Dell", logo: "https://upload.wikimedia.org/wikipedia/commons/5/5c/Dell_logo.svg", deal: "New Season" },
  { name: "JBL", logo: "https://upload.wikimedia.org/wikipedia/commons/2/2c/JBL_logo.svg", deal: "₹1999 onwards" },
  { name: "Bose", logo: "https://upload.wikimedia.org/wikipedia/commons/6/6d/Bose_logo.svg", deal: "30–60% off" },
];
...
const FLASH_DEALS = [
  { title: "iPhone 15 Pro", original: 99990, offer: 84990, off: 15, img: "https://images.unsplash.com/photo-1593642634443-78ec7571ae3d?q=80&w=400&auto=format&fit=crop" },
  { title: "MacBook Pro M3", original: 149990, offer: 124990, off: 16, img: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=400&auto=format&fit=crop" },
  { title: "AirPods Pro", original: 24990, offer: 19990, off: 20, img: "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?q=80&w=400&auto=format&fit=crop" },
  { title: "Samsung Galaxy S24", original: 89990, offer: 74990, off: 16, img: "https://images.unsplash.com/photo-1546868871-7041f2a55e12?q=80&w=400&auto=format&fit=crop" },
  { title: "Sony WH-1000XM5", original: 34990, offer: 27990, off: 20, img: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=400&auto=format&fit=crop" },
  { title: "Dell XPS 13", original: 119990, offer: 99990, off: 16, img: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=400&auto=format&fit=crop" },
];
...
export default function ElectronicsPage() {
  ...
  useEffect(() => {
    const electronicsProducts = allProducts.filter(p => p.category === "Electronics").slice(0, 12);
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F4] font-sans">
      ...
      <div className="bg-gray-900 text-white text-xs text-center py-2 px-4 font-medium tracking-wide">
        🔥 TECH SALE LIVE — Extra 10% off with code <span className="font-black text-orange-400">TECH10</span> &nbsp;|&nbsp; Free shipping above ₹499
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="relative rounded-2xl overflow-hidden h-48 bg-gradient-to-r from-[#0F172A] to-[#1E293B] flex items-center px-8 group cursor-pointer">
            <div className="absolute inset-0 overflow-hidden">
              <Image src="https://images.unsplash.com/photo-1593642634443-78ec7571ae3d?q=80&w=600&auto=format&fit=crop" alt="" fill className="object-cover opacity-30 group-hover:scale-105 transition-transform duration-500" />
            </div>
            <div className="relative z-10">
              <span className="bg-orange-500 text-white text-[10px] font-black px-2 py-1 rounded mb-3 inline-block tracking-wider">SMARTPHONES</span>
              <h3 className="text-3xl font-black text-white leading-tight">Premium<br/>Mobile Experience</h3>
              <Link href="/mobiles/smartphones" className="mt-3 inline-flex items-center gap-1 text-orange-400 font-bold text-sm hover:gap-2 transition-all">
          ...
          <div className="relative rounded-2xl overflow-hidden h-48 bg-gradient-to-r from-[#3B0764] to-[#6B21A8] flex items-center px-8 group cursor-pointer">
            <div className="absolute inset-0 overflow-hidden">
              <Image src="https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=600&auto=format&fit=crop" alt="" fill className="object-cover opacity-30 group-hover:scale-105 transition-transform duration-500" />
            </div>
            <div className="relative z-10">
              <span className="bg-pink-500 text-white text-[10px] font-black px-2 py-1 rounded mb-3 inline-block tracking-wider">GAMING GEAR</span>
              <h3 className="text-3xl font-black text-white leading-tight">Level Up Your<br/>Gaming Setup</h3>
              <Link href="/electronics/gaming" className="mt-3 inline-flex items-center gap-1 text-pink-300 font-bold text-sm hover:gap-2 transition-all">
                Shop Collection <ChevronRight className="w-4 h-4" />
              </Link>
            </div>
          </div>
        ...
        <section className="relative rounded-2xl overflow-hidden">
          ...
          <Image
            src="https://images.unsplash.com/photo-1593642634443-78ec7571ae3d?q=80&w=1200&auto=format&fit=crop"
            alt="Tech Guide"
            width={1200}
            height={300}
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-16">
            <span className="text-orange-400 text-xs font-black tracking-widest mb-3">TECH GUIDE 2025</span>
            <h3 className="text-3xl md:text-4xl font-black text-white leading-tight mb-4">
              Gadgets for Every<br />Occasion
            </h3>
            <Link
              href="/electronics/tech-guide"
            ...
            >
              Explore Tech Guide <ChevronRight className="w-4 h-4" />
            </Link>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { code: "TECH10", desc: "10% off your first order", min: "No minimum spend", color: "from-orange-500 to-red-500" },
            { code: "GAMING20", desc: "₹200 off on ₹999+", min: "Min. order ₹999", color: "from-purple-500 to-pink-500" },
