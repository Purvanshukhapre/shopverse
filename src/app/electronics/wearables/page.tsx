...
export default function WearablesPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get wearable products - filter by category and keyword matching
        const wearableProducts = allProducts.filter(p => 
          ...
          (p.name.toLowerCase().includes('wearable') || 
           ...
           p.description.toLowerCase().includes('wearable'))
        ).slice(0, 8);
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-20">
        <div className="container-premium">
          ...
          >
            ...
            <p className="text-xl mb-6">Smart technology for your lifestyle</p>
            <div className="flex flex-wrap gap-4">
              <Link href="/electronics/wearables" className="btn-premium btn-primary !h-12 !px-8">
                Shop All Wearables
              </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <FilterSidebar 
              ...
              brands={["Apple", "Samsung", "Fitbit", "Garmin", "Oura"]}
              activeFilters={[]}
              onFiltersChange={() => {}}
          ...
          <div className="lg:w-3/4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="h2">All Wearables</h2>
            ...
            {products.length > 0 ? (
              ...
              <div className="text-center py-16">
                <p className="text-lg text-[#555555]">No wearables available at the moment.</p>
              </div>
            )}
          </div>
        </div>
