  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        ...
        const laptopProducts = allProducts.filter(p => p.category === 'Electronics');
    ...
    return (
      <div className="min-h-screen bg-[#F8F8F8]">
        ...
        <div className="container-premium py-16">
          <h1 className="h1 mb-8">Laptops</h1>
    ...
    <div className="min-h-screen bg-[#F8F8F8]">
      ...
      <div className="bg-gradient-to-r from-[#059669] to-[#16A34A] text-white py-20">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-2xl"
          >
            <h1 className="h1 mb-4">Premium Laptops</h1>
            <p className="text-xl mb-6">Powerful computing for professionals and creators</p>
            <div className="flex flex-wrap gap-4">
              <Link href="/electronics/laptops" className="btn-premium btn-primary !h-12 !px-8">
                Shop Laptops
              </Link>
              <Link href="/electronics/headphones" className="btn-premium !h-12 !px-8 bg-white text-[#059669] hover:bg-gray-100">
                Shop Headphones
              </Link>
            </div>
          </motion.div>
      ...
      <div className="container-premium pb-24">
        <div className="flex items-center justify-between mb-8">
          <h2 className="h2">Featured Laptops</h2>
          <Link href="/electronics/laptops" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
            View All →
          </Link>
        </div>
