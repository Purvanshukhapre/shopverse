  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        ...
        const accessoriesProducts = allProducts.filter(p => p.category === 'Electronics');
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Accessories</h1>
            <p className="text-xl mb-6">Essential add-ons and upgrades for your devices</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From cables and chargers to cases, screen protectors, and more.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Certified & compatible accessories</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">For phones, laptops, tablets & more</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Accessory Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Cables</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Cables & Adapters</h3>
                <p className="text-[#555555] mb-4">USB-C, Lightning, HDMI & multi-port adapters</p>
                <Link href="/electronics/accessories/cables" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Cases</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Cases & Covers</h3>
                <p className="text-[#555555] mb-4">Protective cases for all your devices</p>
                <Link href="/electronics/accessories/cases" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Screen Protectors</h3>
                <p className="text-[#555555] mb-4">Tempered glass & privacy filters</p>
                <Link href="/electronics/accessories/screen" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Accessory Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Accessories Available</h3>
              <p className="text-[#555555] mb-6">We&apos;re working on expanding our accessory collection. Check back soon!</p>
              <Link href="/electronics" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Electronics
              </Link>
            </div>
