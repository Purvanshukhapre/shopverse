...
export default function AccessoriesPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get accessory products - filter by category and keyword matching
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-20">
        <div className="container-premium">
          ...
          >
            ...
            <p className="text-xl mb-6">Premium electronics accessories</p>
            <div className="flex flex-wrap gap-4">
              <Link href="/electronics/accessories" className="btn-premium btn-primary !h-12 !px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <FilterSidebar 
              ...
              brands={["Anker", "Belkin", "Samsung", "Apple", "Spigen"]}
              activeFilters={[]}
              onFiltersChange={() => {}}
          ...
          <div className="lg:w-3/4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="h2">All Accessories</h2>
