...
export default function MicrowavesPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get microwaves products
        const microwavesProducts = allProducts.filter(p => p.category === 'Home');
        setProducts(microwavesProducts);
      } catch (error) {
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Microwaves</h1>
            <p className="text-xl mb-6">Premium microwave ovens for quick and convenient cooking</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From compact countertop models to built-in microwaves with advanced cooking features.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Inverter technology & smart cooking</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Countertop & built-in models</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Microwave Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Countertop</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Countertop</h3>
                <p className="text-[#555555] mb-4">Compact models for kitchen countertops</p>
                <Link href="/appliances/microwaves/countertop" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Built-in</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Built-in</h3>
                <p className="text-[#555555] mb-4">Integrated into kitchen cabinetry</p>
                <Link href="/appliances/microwaves/built-in" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Convection</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Convection</h3>
                <p className="text-[#555555] mb-4">Combines microwave & oven functionality</p>
                <Link href="/appliances/microwaves/convection" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Microwave Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Microwaves Available</h3>
              <p className="text-[#555555] mb-6">We&apos;re working on expanding our microwave collection. Check back soon!</p>
              <Link href="/appliances" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Appliances
              </Link>
            </div>
