...
export default function AirPurifiersPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get air purifiers products
        const airPurifiersProducts = allProducts.filter(p => p.category === 'Home');
        setProducts(airPurifiersProducts);
      } catch (error) {
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Air Purifiers</h1>
            <p className="text-xl mb-6">Premium air purification solutions for healthy living</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From HEPA filters and activated carbon to smart air purifiers with real-time monitoring.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">HEPA filtration & smart sensors</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">For rooms of all sizes</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Air Purifier Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">HEPA</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">HEPA Filters</h3>
                <p className="text-[#555555] mb-4">Captures 99.97% of airborne particles</p>
                <Link href="/appliances/air-purifiers/hepa" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Activated</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Activated Carbon</h3>
                <p className="text-[#555555] mb-4">Removes odors, gases & VOCs</p>
                <Link href="/appliances/air-purifiers/activated-carbon" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Smart Purifiers</h3>
                <p className="text-[#555555] mb-4">WiFi-enabled with app control & air quality monitoring</p>
                <Link href="/appliances/air-purifiers/smart" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Air Purifier Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Air Purifiers Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our air purifier collection. Check back soon!</p>
              <Link href="/appliances" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Appliances
              </Link>
            </div>
