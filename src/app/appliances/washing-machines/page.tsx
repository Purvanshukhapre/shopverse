...
export default function WashingMachinesPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get washing machines products
        const washingMachinesProducts = allProducts.filter(p => p.category === 'Home');
        setProducts(washingMachinesProducts);
      } catch (error) {
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Washing Machines</h1>
            <p className="text-xl mb-6">Premium laundry solutions for your home</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From energy-efficient top-load models to smart front-load washers with advanced features.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Energy-efficient & gentle on clothes</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Top-load & front-load models</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Washing Machine Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Top Load</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Top Load</h3>
                <p className="text-[#555555] mb-4">Traditional design with high capacity</p>
                <Link href="/appliances/washing-machines/top-load" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Front Load</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Front Load</h3>
                <p className="text-[#555555] mb-4">Energy-efficient with superior cleaning</p>
                <Link href="/appliances/washing-machines/front-load" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Semi-Automatic</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Semi-Automatic</h3>
                <p className="text-[#555555] mb-4">Budget-friendly with manual operation</p>
                <Link href="/appliances/washing-machines/semi-automatic" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Washing Machine Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Washing Machines Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our washing machine collection. Check back soon!</p>
              <Link href="/appliances" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Appliances
              </Link>
            </div>
