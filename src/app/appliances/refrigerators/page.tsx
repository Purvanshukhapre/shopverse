      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Energy-efficient & frost-free technology</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Single, double & French door models</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Refrigerator Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Double Door</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Double Door</h3>
                <p className="text-[#555555] mb-4">Spacious storage with separate compartments</p>
                <Link href="/appliances/refrigerators/double-door" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">French Door</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">French Door</h3>
                <p className="text-[#555555] mb-4">Premium design with spacious freezer compartment</p>
                <Link href="/appliances/refrigerators/french-door" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Side-by-Side</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Side-by-Side</h3>
                <p className="text-[#555555] mb-4">Equal width compartments for easy access</p>
                <Link href="/appliances/refrigerators/side-by-side" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Refrigerator Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Refrigerators Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our refrigerator collection. Check back soon!</p>
              <Link href="/appliances" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Appliances
              </Link>
            </div>
