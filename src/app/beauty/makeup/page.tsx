...
export default function MakeupPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get makeup products
        const makeupProducts = allProducts.filter(p => p.category === 'Beauty');
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Makeup</h1>
            <p className="text-xl mb-6">Premium cosmetics for flawless beauty and confidence</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From foundations and lipsticks to eyeshadows and brushes.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Dermatologist-tested & cruelty-free</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">For all skin tones & types</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Makeup Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Face</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Face Makeup</h3>
                <p className="text-[#555555] mb-4">Foundations, concealers & powders</p>
                <Link href="/beauty/makeup/face" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Eyes</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Eye Makeup</h3>
                <p className="text-[#555555] mb-4">Mascara, eyeshadow & eyeliner</p>
                <Link href="/beauty/makeup/eyes" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Lips</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Lip Makeup</h3>
                <p className="text-[#555555] mb-4">Lipsticks, glosses & liners</p>
                <Link href="/beauty/makeup/lips" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Makeup Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Makeup Products Available</h3>
              <p className="text-[#555555] mb-6">We&apos;re working on expanding our makeup collection. Check back soon!</p>
              <Link href="/beauty" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Beauty
              </Link>
            </div>
