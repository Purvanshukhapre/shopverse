      ...
      try {
        ...
        const makeupProducts = allProducts.filter(p => p.category === 'Beauty' && 
          (p.name.toLowerCase().includes('foundation') || 
           ...
           p.name.toLowerCase().includes('eyeshadow') || 
           p.name.toLowerCase().includes('blush') || 
           p.name.toLowerCase().includes('concealer')));
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <FilterSidebar 
              ...
              brands={["MAC", "NARS", "Charlotte Tilbury", "Anastasia Beverly Hills", "Fenty Beauty"]}
              activeFilters={[]}
              onFiltersChange={() => {}}
