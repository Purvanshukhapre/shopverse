        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <FilterSidebar 
              ...
              brands={["Philips", "Braun", "Panasonic", "Gillette", "Harry's"]}
              activeFilters={[]}
              onFiltersChange={() => {}}
          ...
          <div className="lg:w-3/4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="h2">All Grooming Products</h2>
            ...
            {products.length > 0 ? (
              ...
              <div className="text-center py-16">
                <p className="text-lg text-[#555555]">No grooming products available at the moment.</p>
              </div>
            )}
          </div>
        </div>
