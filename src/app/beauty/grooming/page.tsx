  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        ...
        const groomingProducts = allProducts.filter(p => p.category === 'Beauty');
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Grooming</h1>
            <p className="text-xl mb-6">Premium grooming essentials for men and women</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From shaving kits and beard care to skincare tools and hair styling.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Professional-grade & dermatologist-tested</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">For men, women & all grooming needs</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Grooming Category</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Shaving</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Shaving Kits</h3>
                <p className="text-[#555555] mb-4">Razors, blades & shaving creams</p>
                <Link href="/beauty/grooming/shaving" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Beard</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Beard Care</h3>
                <p className="text-[#555555] mb-4">Oils, balms & grooming tools</p>
                <Link href="/beauty/grooming/beard" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Hair</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Hair Styling</h3>
                <p className="text-[#555555] mb-4">Styling tools, gels & sprays</p>
                <Link href="/beauty/grooming/hair" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Grooming Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Grooming Products Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our grooming collection. Check back soon!</p>
              <Link href="/beauty" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Beauty
              </Link>
            </div>
