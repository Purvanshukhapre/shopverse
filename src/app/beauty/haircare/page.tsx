  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        ...
        const haircareProducts = allProducts.filter(p => p.category === 'Beauty');
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Haircare</h1>
            <p className="text-xl mb-6">Premium hair care products for healthy, beautiful hair</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From shampoos and conditioners to styling products and treatments.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Dermatologist-tested & salon-grade</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">For all hair types & concerns</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Hair Concern</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Dry</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Dry & Damaged Hair</h3>
                <p className="text-[#555555] mb-4">Hydrating shampoos & deep conditioning treatments</p>
                <Link href="/beauty/haircare/dry" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Oily</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Oily Hair</h3>
                <p className="text-[#555555] mb-4">Clarifying shampoos & lightweight conditioners</p>
                <Link href="/beauty/haircare/oily" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Color</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Color-Treated Hair</h3>
                <p className="text-[#555555] mb-4">Sulfate-free shampoos & color-protecting treatments</p>
                <Link href="/beauty/haircare/color" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Haircare Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Haircare Products Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our haircare collection. Check back soon!</p>
              <Link href="/beauty" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Beauty
              </Link>
            </div>
