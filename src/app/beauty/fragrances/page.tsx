      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Eau de Parfum & Eau de Toilette</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">For men, women & unisex scents</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Fragrance Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Women's Perfumes</h3>
                <p className="text-[#555555] mb-4">Floral, fruity & oriental scents</p>
                <Link href="/beauty/fragrances/womens" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Men's Colognes</h3>
                <p className="text-[#555555] mb-4">Woody, fresh & aquatic scents</p>
                <Link href="/beauty/fragrances/mens" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Unisex</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Unisex Scents</h3>
                <p className="text-[#555555] mb-4">Modern, clean & versatile fragrances</p>
                <Link href="/beauty/fragrances/unisex" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Fragrance Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Fragrances Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our fragrance collection. Check back soon!</p>
              <Link href="/beauty" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Beauty
              </Link>
            </div>
