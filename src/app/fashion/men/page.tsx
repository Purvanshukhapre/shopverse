...
export default function MenClothingPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get men's clothing products - filter by category and keyword matching
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <FilterSidebar 
              ...
              brands={["Nike", "Adidas", "Levi&apos;s", "Calvin Klein", "Tommy Hilfiger"]}
              activeFilters={[]}
              onFiltersChange={() => {}}
          ...
          <div className="lg:w-3/4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="h2">All Men&apos;s Clothing</h2>
