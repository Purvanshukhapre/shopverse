  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        ...
        const menProducts = allProducts.filter(p => p.category === 'Fashion');
    ...
    return (
      <div className="min-h-screen bg-[#F8F8F8]">
        ...
        <div className="container-premium py-16">
          <h1 className="h1 mb-8">Men's Clothing</h1>
    ...
    <div className="min-h-screen bg-[#F8F8F8]">
      ...
      <div className="bg-gradient-to-r from-[#DC2626] to-[#B91C1C] text-white py-20">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-2xl"
          >
            <h1 className="h1 mb-4">Men's Clothing</h1>
            <p className="text-xl mb-6">Premium apparel for the modern man</p>
      ...
      <div className="container-premium pb-24">
        <div className="flex items-center justify-between mb-8">
          <h2 className="h2">Featured Men's Clothing</h2>
          <Link href="/fashion/men" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
            View All →
          </Link>
        </div>
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-16">
            <p className="text-lg text-[#555555]">No men's clothing available at the moment.</p>
          </div>
        )}
      </div>
