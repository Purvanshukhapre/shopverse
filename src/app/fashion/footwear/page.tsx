...
export default function FootwearPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get footwear products - filter by category and keyword matching
        const footwearProducts = allProducts.filter(p => 
          ...
          (p.name.toLowerCase().includes('shoe') || 
           ...
           p.name.toLowerCase().includes('sandals'))
        ).slice(0, 8);
      ...
      <div className="bg-gradient-to-r from-[#DC2626] to-[#B91C1C] text-white py-20">
        <div className="container-premium">
          ...
          >
            ...
            <p className="text-xl mb-6">Premium shoes and boots</p>
            <div className="flex flex-wrap gap-4">
              <Link href="/fashion/footwear" className="btn-premium btn-primary !h-12 !px-8">
                Shop All Footwear
              </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-3/4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="h2">All Footwear</h2>
