  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        ...
        const footwearProducts = allProducts.filter(p => p.category === 'Fashion');
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Footwear</h1>
            <p className="text-xl mb-6">Step into style with our premium collection of shoes and sandals</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From casual sneakers to formal shoes, discover footwear that combines comfort, quality, and fashion.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Leather, canvas & breathable materials</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Men, women & kids sizes</p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Sneakers & Casual</h3>
                <p className="text-[#555555] mb-4">Comfortable everyday footwear</p>
                <Link href="/fashion/footwear/casual" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Formal</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Formal Shoes</h3>
                <p className="text-[#555555] mb-4">Elegant footwear for office & events</p>
                <Link href="/fashion/footwear/formal" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Sports & Training</h3>
                <p className="text-[#555555] mb-4">Performance footwear for athletes</p>
                <Link href="/fashion/footwear/sports" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Footwear Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Footwear Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our footwear collection. Check back soon!</p>
              <Link href="/fashion" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Fashion
              </Link>
            </div>
