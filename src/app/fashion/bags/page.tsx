...
export default function BagsPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get bags products
        const bagsProducts = allProducts.filter(p => p.category === 'Fashion');
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Bags & Wallets</h1>
            <p className="text-xl mb-6">Stylish and functional accessories for every occasion</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From elegant handbags to practical backpacks and premium wallets.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Genuine leather & durable materials</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Handbags, backpacks, wallets & more</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Handbags</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Elegant Handbags</h3>
                <p className="text-[#555555] mb-4">Perfect for work, events & everyday use</p>
                <Link href="/fashion/bags/handbags" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Backpacks</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Durable Backpacks</h3>
                <p className="text-[#555555] mb-4">For students, professionals & travelers</p>
                <Link href="/fashion/bags/backpacks" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Wallets</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Premium Wallets</h3>
                <p className="text-[#555555] mb-4">Leather wallets, card holders & money clips</p>
                <Link href="/fashion/bags/wallets" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Bags Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Bags Available</h3>
              <p className="text-[#555555] mb-6">We&apos;re working on expanding our bags collection. Check back soon!</p>
              <Link href="/fashion" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Fashion
              </Link>
            </div>
