...
export default function BagsPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get bag products - filter by category and keyword matching
      ...
      <div className="bg-gradient-to-r from-[#DC2626] to-[#B91C1C] text-white py-20">
        <div className="container-premium">
          ...
          >
            ...
            <p className="text-xl mb-6">Premium fashion accessories</p>
            <div className="flex flex-wrap gap-4">
              <Link href="/fashion/bags" className="btn-premium btn-primary !h-12 !px-8">
                Shop All Bags
              </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <FilterSidebar 
              ...
              brands={["Louis Vuitton", "Gucci", "Prada", "Coach", "Michael Kors"]}
              activeFilters={[]}
              onFiltersChange={() => {}}
          ...
          <div className="lg:w-3/4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="h2">All Bags & Wallets</h2>
            ...
            {products.length > 0 ? (
              ...
              <div className="text-center py-16">
                <p className="text-lg text-[#555555]">No bags available at the moment.</p>
              </div>
            )}
          </div>
        </div>
