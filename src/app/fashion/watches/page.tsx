  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        ...
        const watchesProducts = allProducts.filter(p => p.category === 'Fashion');
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Watches</h1>
            <p className="text-xl mb-6">Timeless elegance and precision engineering</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              Discover premium watches that combine style, functionality, and craftsmanship.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Swiss movements & sapphire crystal</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Men, women & kids styles</p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Analog</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Analog Watches</h3>
                <p className="text-[#555555] mb-4">Classic timepieces with traditional dials</p>
                <Link href="/fashion/watches/analog" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Digital Watches</h3>
                <p className="text-[#555555] mb-4">Feature-rich digital displays</p>
                <Link href="/fashion/watches/digital" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Smart Watches</h3>
                <p className="text-[#555555] mb-4">Advanced features & health tracking</p>
                <Link href="/fashion/watches/smart" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Watch Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Watches Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our watch collection. Check back soon!</p>
              <Link href="/fashion" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Fashion
              </Link>
            </div>
