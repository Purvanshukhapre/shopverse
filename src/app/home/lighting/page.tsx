  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        ...
        const lightingProducts = allProducts.filter(p => p.category === 'Home');
      ...
      <div className="bg-gradient-to-r from-[#111111] to-[#333333] text-white py-24">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="h1 mb-4">Lighting</h1>
            <p className="text-xl mb-6">Illuminate your space with premium lighting solutions</p>
            <p className="text-lg text-[#AAAAAA] mb-8">
              From elegant chandeliers to modern LED fixtures and smart lighting.
            </p>
      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Energy-efficient & designer lighting</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">For every room in your home</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Lighting Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Ceiling</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Ceiling Lights</h3>
                <p className="text-[#555555] mb-4">Chandeliers, pendant lights & flush mounts</p>
                <Link href="/home/lighting/ceiling" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Table</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Table Lamps</h3>
                <p className="text-[#555555] mb-4">Desk lamps, reading lamps & decorative table lights</p>
                <Link href="/home/lighting/table" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Smart Lighting</h3>
                <p className="text-[#555555] mb-4">WiFi-enabled & voice-controlled lighting</p>
                <Link href="/home/lighting/smart" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Lighting Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Lighting Available</h3>
              <p className="text-[#555555] mb-6">We&apos;re working on expanding our lighting collection. Check back soon!</p>
              <Link href="/home" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Home & Living
              </Link>
            </div>
