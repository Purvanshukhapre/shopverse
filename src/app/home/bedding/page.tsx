      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Egyptian cotton, silk & premium fabrics</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">For every bedroom in your home</p>
          </div>
        </div>
        
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Bedding Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Sheets</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Bed Sheets</h3>
                <p className="text-[#555555] mb-4">Cotton, linen & silk sheet sets</p>
                <Link href="/home/bedding/sheets" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#111111] to-[#333333] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Duvets</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Duvets & Comforters</h3>
                <p className="text-[#555555] mb-4">All-season & luxury down alternatives</p>
                <Link href="/home/bedding/duvets" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Pillows</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Pillows & Cushions</h3>
                <p className="text-[#555555] mb-4">Memory foam, down & decorative pillows</p>
                <Link href="/home/bedding/pillows" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Bedding Collection</h2>
