      ...
      <div className="container-premium py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl border border-gray-100 text-center">
            ...
            <p className="text-[#555555]">Handcrafted & designer pieces</p>
          </div>
        ...
        {/* Featured Categories */}
        <div className="mb-16">
          <h2 className="h2 mb-8">Shop by Décor Type</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#DC2626] to-[#B91C1C] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Wall Art</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Wall Art</h3>
                <p className="text-[#555555] mb-4">Paintings, prints, mirrors & wall hangings</p>
                <Link href="/home/decor/wall-art" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-6">
                <h3 className="h3 mb-2">Lighting</h3>
                <p className="text-[#555555] mb-4">Lamps, chandeliers & ambient lighting</p>
                <Link href="/home/decor/lighting" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="aspect-[4/3] bg-gradient-to-r from-[#15803D] to-[#166534] relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-white text-2xl font-bold">Vases</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="h3 mb-2">Vases & Bowls</h3>
                <p className="text-[#555555] mb-4">Ceramic, glass & metallic decorative pieces</p>
                <Link href="/home/decor/vases" className="text-[#DC2626] font-semibold hover:text-[#B91C1C] transition-colors">
                  Shop Now →
                </Link>
              </div>
            </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="h2">Décor Collection</h2>
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="h3 mb-2">No Décor Available</h3>
              <p className="text-[#555555] mb-6">We're working on expanding our décor collection. Check back soon!</p>
              <Link href="/home" className="btn-premium btn-primary !h-12 !px-8">
                Browse All Home & Living
              </Link>
            </div>
