...
export default function HomePage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Filter products by Home & Living category
    ...
    return (
      <div className="min-h-screen bg-[#F8F8F8]">
        ...
        <div className="container-premium py-16">
          <h1 className="h1 mb-8">Home & Living</h1>
    ...
    <div className="min-h-screen bg-[#F8F8F8]">
      ...
      <div className="bg-gradient-to-r from-[#1E3A8A] to-[#3B82F6] text-white py-20">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-2xl"
          >
            <h1 className="h1 mb-4">Home & Living</h1>
            <p className="text-xl mb-6">Transform your space with premium home essentials</p>
            <div className="flex flex-wrap gap-4">
              <Link href="/home/furniture" className="btn-premium btn-primary !h-12 !px-8">
                Shop Furniture
              </Link>
              <Link href="/home/decor" className="btn-premium !h-12 !px-8 bg-white text-[#1E3A8A] hover:bg-gray-100">
                Shop Decor
              </Link>
            </div>
          </motion.div>
      ...
      <div className="container-premium pb-24">
        <div className="flex items-center justify-between mb-8">
          <h2 className="h2">Featured Home Essentials</h2>
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-16">
            <p className="text-lg text-[#555555]">No home & living products available at the moment.</p>
          </div>
        )}
      </div>
