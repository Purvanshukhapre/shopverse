...
export default function SportsFootwearPage() {
  ...
  useEffect(() => {
    const fetchProducts = () => {
      try {
        // Get sports footwear products
        const sportsFootwearProducts = allProducts.filter(p => p.category === 'Sports' && 
        ...
        setProducts(sportsFootwearProducts);
      } catch (error) {
        console.error('Error fetching sports footwear products:', error);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="bg-gradient-to-r from-[#1E3A8A] to-[#3B82F6] text-white py-20">
        <div className="container-premium">
          <motion.div 
            ...
            className="max-w-2xl"
          >
            <h1 className="h1 mb-4">Sports Footwear</h1>
            <p className="text-xl mb-6">Performance shoes for every sport</p>
            <div className="flex flex-wrap gap-4">
              <Link href="/sports/sports-footwear" className="btn-premium btn-primary !h-12 !px-8">
                Shop All Sports Footwear
              </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <FilterSidebar 
              ...
              brands={["Nike", "Adidas", "New Balance", "Asics", "Brooks"]}
              activeFilters={[]}
              onFiltersChange={() => {}}
          ...
          <div className="lg:w-3/4">
            <div className="flex items-center justify-between mb-8">
              <h2 className="h2">All Sports Footwear</h2>
            ...
            {products.length === 0 && !loading && (
              <div className="text-center py-16">
                ...
                <h3 className="h3 mb-2">No Sports Footwear Available</h3>
                <p className="text-[#555555] mb-6">We're working on expanding our sports footwear collection. Check back soon!</p>
